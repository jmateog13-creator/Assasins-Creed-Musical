    ...
    showFinalScreen() {
        ...
        content.innerHTML = `
            <div class="final-screen">
                ...
                <p style="font-size: 1.4em; margin-bottom: 25px;">Heu derrotat definitivament l'Ordre dels Templars i restaurat la història de l'harmonia musical!</p>
                <p style="margin-bottom: 30px;">Com a <strong style="color: #00d4ff;">GRAN MESTRE ASSASSÍ DE L'HARMONIA</strong>, heu sobreviscut a tots els perills temporals i recollit els ${gameData.fragments.length} Fragments Sagrats.</p>
                ...
                <div style="background: rgba(0, 255, 136, 0.1); padding: 20px; margin: 30px 0; border-left: 4px solid #00ff88;">
                    <p style="font-style: italic; font-size: 1.1em;">
                        <strong>"MISSIÓ ANIMUS COMPLETA. Els Templars han estat eliminats de la història harmònica. La humanitat pot gaudir lliurement de l'harmonia per a totes les generacions futures."</strong>
                    </p>
                ...
                <p style="margin: 25px 0; font-size: 1.3em;">RANG FINAL: <strong style="color: #00ff88;">LLEGENDA DE L'HARMONIA ETERNA</strong></p>
