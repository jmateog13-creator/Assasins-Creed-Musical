// Objecte UI per gestionar la interfície d'usuari (VERSIÓ TEXTURA)
const ui = {
    ...
    showFinalScreen() {
        ...
        content.innerHTML = `
            <div class="final-screen">
                ...
                <p style="font-size: 1.4em; margin-bottom: 25px;">Heu derrotat definitivament l'Ordre dels Templars i restaurat la història de la textura musical!</p>
                <p style="margin-bottom: 30px;">Com a <strong style="color: #00d4ff;">GRAN MESTRE ASSASSÍ DE LA TEXTURA</strong>, heu sobreviscut i recollit els ${gameData.fragments.length} Fragments Sagrats.</p>
                ...
                <div style="background: rgba(0, 255, 136, 0.1); padding: 20px; margin: 30px 0; border-left: 4px solid #00ff88;">
                    <p style="font-style: italic; font-size: 1.1em;">
                        <strong>"MISSIÓ ANIMUS COMPLETA. Els Templars han estat eliminats de la línia temporal. La humanitat pot gaudir lliurement de la riquesa de la textura musical."</strong>
                    </p>
                    <p style="text-align: right; margin-top: 15px; color: #00d4ff;">
                        <em>— PROJECTE 'FRAGMENTS DE LA TEXTURA' TANCAT</em>
                    </p>
                </div>
                
                <p style="margin: 25px 0; font-size: 1.3em;">RANG FINAL: <strong style="color: #00ff88;">LLEGENDA DEL TEIXIT SONOR</strong></p>
